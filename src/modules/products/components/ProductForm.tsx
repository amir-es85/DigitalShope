...
function ProductForm(prop: { product: ProductWithImages | null }) {
    const { product } = prop;
    const { handleSubmit, register, setValue,control,formState:{errors,isSubmitting} } = useForm<FormProduct>()
            ...
            <form className="" onSubmit={handleSubmit(onsubmit)}>
                ...
                <CardContent >
                    <div className="mb-2.5 mt-2.5">
                        ...
                        <Input defaultValue={product?.name || ""} {...register("name",{required:"name is requred"})} className="h-8"/>
                    ...
                    <div className="mb-2.5">
                        ...
                        <Textarea defaultValue={product?.description || ""} {...register("description",{required:"Description is required"})} className="h-8"/>
                    ...
                    <div className="mb-2.5">
                        ...
                        <Input defaultValue={product?.quantity || ""} {...register("quantity")} className="h-8"/>
                    </div>
